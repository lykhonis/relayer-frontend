                ...
                {!profile ? (
                  ...
                  <>
                    <Popover as="div" className="ml-4 relative flex-shrink-0">
                      <Popover.Button className="bg-white rounded-full flex text-sm ring-2 ring-white ring-opacity-20 focus:outline-none focus:ring-opacity-100">
                        {profileImage ? (
                          <img
                      ...
                      >
                        <Popover.Panel className="origin-top-right z-40 absolute -right-2 mt-2 w-48 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5 focus:outline-none">
                          <div className="relative rounded-lg bg-white p-5 shadow-sm flex items-center space-x-3">
                            <div className="flex-shrink-0">
                              {profileImage ? (
                                <img
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              <div className="flex flex-row">
                                <p className="text-sm text-gray-500 truncate">
                                  {shortenAddress(profile?.address ?? '', 2)}
                                </p>
